    ...
    public function run(): void
    {
        ...
        $tiers = [
            ...
            [
                ...
                'max_order_amount' => 0,
                'min_completed_deliveries' => 200,
                'min_security_deposit' => 50000,
                'max_security_deposit' => 50000,
                'description' => 'Highest agent level before leadership — no order amount cap',
                'active' => true,
                'commission_percent' => 10.00,
                'annual_reward_amount' => 0,
